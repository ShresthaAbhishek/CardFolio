...
import Discoverme from '../../../../public/icons/Discover_me.png'; // Path to the first logo
import AbhishekExp from '../../../../public/icons/Abhishek_Experience.png'; // Path to the second logo
...
export const CreditCard: React.FC<CreditCardProps> = ({ 
  ...
  const cards = [
    ...
    { id: 1, name: "John Doe", color: "from-[#bb9b49] to-[#ebd197]" },
...
{/* Second card - Abhishek Experience */}
{index === 1 && (
  <Image
    src={AbhishekExp}
    alt="Abhishek Experience Logo"
    width={180}
    height={60}
    className={`${styles.abhishekLogo}`} 
  />
)}
